...
public class VolRechercher extends JFrame {
	 ...
	 */
	public VolRechercher(String date,int idDep,int idDes) throws ClassNotFoundException, SQLException {
	...
	public void initComponents()
	{
		...
		btnAcheter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Reservation R=new Reservation(idVol);
				try {
